            ...
            <div class="aa-sidebar-widget">
              ...
              <div class="aa-sidebar-price-range">
                ...
                <form action="?" method="POST" enctype="multipart/form-data">
                  ...
                  <span id="skip-value-lower" class="example-val" name="lwr_price"><?php echo $lower ?></span>
                  <input type="range" id="skip-value-lower" class="example-val" name="lwr_price" min="0" max="100">

                  <span id="skip-value-upper" class="example-val" name="upr_price"><?php echo $upper ?></span>
                  <input type="range" id="skip-value-upper" class="example-val" name="upr_price" min="0" max="10000">

                  <button class="aa-filter-btn" type="submit" name="filter_price">Filter PRICE</button>
                </form>
